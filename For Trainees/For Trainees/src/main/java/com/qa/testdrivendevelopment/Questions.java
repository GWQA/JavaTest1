...
public class Questions {
	 ...
	 * 
	 * For Example: fibbonaci(0) → 0 fibbonaci(1) → 1 fibbonaci(2) → 1
	 * fibbonaci(3) → 2 fibbonaci(4) → 3 fibbonaci(5) → 5 fibbonaci(8) → 21
	 */
	 ...
	 * validCard("0123-4567-8901-2345") → False validCard("401234567890123") →
	 * False validCard("4012 3456 7890 1234") → False
	 * validCard("4444-0123-4567-8901") → False validCard("4012345678901234") →
	 * True
	 */
